                ...
                <div className="space-y-6">
                    <h1 className="text-6xl md:text-8xl font-urbanist font-black leading-[0.9] text-white tracking-tight flex items-center gap-4 whitespace-nowrap">
                        ...
                        <RotatingText
                          ...
                          mainClassName="px-3 sm:px-3 md:px-4 bg-cyber-primary text-black overflow-hidden py-0 sm:py-1 md:py-2 justify-center rounded-lg"
                          staggerFrom="last"
                          initial={{ y: "100%" }}
                          animate={{ y: 0 }}
                          exit={{ y: "-120%" }}
                          staggerDuration={0.025}
                          splitLevelClassName="overflow-visible pb-2 sm:pb-3"
